...
# 페이지 기본 설정
st.set_page_config(
    page_title="어제 박스오피스 TOP 10", page_icon="🎬", layout="wide"
)
...
def main():
    ...
    st.caption(f"📅 기준일: {display_date_str}")
